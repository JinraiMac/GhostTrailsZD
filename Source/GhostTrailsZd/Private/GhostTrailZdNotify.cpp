...
void UGhostTrailZdNotify::OnReceiveNotify_Implementation(UPaperZDAnimInstance* OwningInstance /* = nullptr */) const
{
	...
	if (OwningInstance)
	{
		...
		AGhostTrail2dBase* trailActor = SpriteComponentOwner->GetWorld()->SpawnActorDeferred<AGhostTrail2dBase>(TrailClass, Transform, SpriteComponentOwner, nullptr, ESpawnActorCollisionHandlingMethod::AlwaysSpawn);
...
FName UGhostTrailZdNotify::GetDisplayName_Implementation() const
{
	return FName("GhostTrail");
}
